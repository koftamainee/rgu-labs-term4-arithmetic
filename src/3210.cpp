...
int main() {
    ...
    // -----------------------------------------------------------------------
    // b) 6x1 - 2cos(x2*x3) - 1 = 0
    //    9x2 + sqrt(x1^2 + sin(x3) + 1.06) + 0.9 = 0
    //    60x3 + 3e^(-x1*x2) + 10*pi - 3 = 0
    // -----------------------------------------------------------------------
    std::cout << "=== b) ===\n\n";
    {
        auto F = [](const Vector &v) -> Vector {
    ...
    //    x1-2x2+3x3 = x3*x4
    //    x1^2+x2^2+x3^2 = 1
    // Rewrite: F1=4x1-x2+x3-x1*x4, F2=-x1+3x2-2x3-x2*x4,
    //          F3=x1-2x2+3x3-x3*x4, F4=x1^2+x2^2+x3^2-1
    // unknowns: x1,x2,x3,x4
    // 3 eigenvalues: 1, 3, 6  (analytical)
    // -----------------------------------------------------------------------
    std::cout << "=== c) ===\n";
